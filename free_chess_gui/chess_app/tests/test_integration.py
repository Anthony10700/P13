...
class TestChessAppIntegration(TransactionTestCase):
    ...
    def setUp(self):
        ...
        Game_chess.objects.create(
            pgn='[Event "Chess game AT"][Site "?"][Date "????.??.??"][Round "?"][White "?"][Black "?"][Result "*"]1. Nf3 d5 2. c4 d4 3. b4 c5 4. e3 Nf6 *',
            last_fen="rnbqkb1r/pp2pppp/5n2/2p5/1PPp4/4PN2/P2P1PPP/RNBQKB1R w KQkq - 1 5",
            last_move="g8f6",
            player_black=self.user,
            player_white=self.user2)
        Game_chess.objects.create(
            pgn='[Event "Chess game AT"][Site "?"][Date "????.??.??"][Round "?"][White "?"][Black "?"][Result "*"]1. Nf3 d5 2. c4 d4 3. b4 c5 4. e3 *',
            last_fen="rnbqkbnr/pp2pppp/8/2p5/1PPp4/4PN2/P2P1PPP/RNBQKB1R b KQkq - 0 4",
            last_move="e2e3",
            player_black=self.user,
            player_white=self.user2)
    ...
    def test_add_last_move_to_pgn(self):
        ...
        last_fen = "rnbqkbnr/pp2pppp/8/2p5/1PPp4/4PN2/P2P1PPP/RNBQKB1R b KQkq - 0 4"
        verify_last_fen = "rnbqkb1r/pp2pppp/5n2/2p5/1PPp4/4PN2/P2P1PPP/RNBQKB1R w KQkq - 1 5"
    ...
    def test_lc0_play_next_move(self):
        ...
        """
        fen = "rnbqkbnr/pppp1ppp/8/8/6P1/P4N1P/1PPPPp2/RNBQKB1R w KQkq - 0 5"
